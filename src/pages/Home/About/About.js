    ...
    return (
        <div className="hero my-24">
            <div className="hero-content flex-col lg:flex-row">
                ...
                <div className='w-1/2'>
                    <h3 className="font-bold text-2xl text-orange-400">About Us</h3>
                    <h1 className="text-5xl font-bold">We are qualified & of experience in this field</h1>
                    <p className="py-6 my-5">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. 
                    <br/> <br/>
